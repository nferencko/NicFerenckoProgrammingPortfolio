...
- **My role on this project:** In this project, I wrote the main menu (driver) along with the card simulations.  In my card simulations, I was able to reuse many of the classes I had written for the BlackJack game. Specifically, I wrote BlackJackHand.java, Card.java, CardMenu.java, CardSimulations.java, DeckOfCards.java, MainMenu.java, and PokerHand.java.
