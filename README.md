...
-  **My role on this project:** I wrote several classes using object-oriented design principles.  Specifically, the classes I wrote for the project were the [Card class](https://github.com/nferencko/NicFerenckoProgrammingPortfolio/blob/main/BlackJack/src/Card.java) (representing a single Card), the [DeckOfCard class](https://github.com/nferencko/NicFerenckoProgrammingPortfolio/blob/main/BlackJack/src/DeckOfCard.java) (a collection of Cards backed by an ArrayList), and the BlackJackHand class (another collection of cards representing a player’s hand).  Additionally, I helped my partner with some aspects of the Applications class (the program driver).
...
- **My role on this project:** In this project, I wrote the main menu (driver) along with the card simulations.  In my card simulations, I was able to reuse many of the classes I had written for the BlackJack game. Specifically, I wrote in this project were BlackJackHand.java, Card.java, CardMenu.java, CardSimulations.java, DeckOfCards.java, MainMenu.java, and PokerHand.java.
